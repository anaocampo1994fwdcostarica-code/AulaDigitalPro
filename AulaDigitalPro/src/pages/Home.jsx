...
function CategoryBadge({ category, level }) {
  const colors = {
    ...
    'Diseno': { bg: 'rgba(139,92,246,0.18)', color: '#A78BFA' },
  ...
  const levelColors = {
    ...
    'Avanzado': { bg: 'rgba(14,165,233,0.18)', color: '#38BDF8' },
    default: { bg: 'rgba(255,255,255,0.14)', color: '#E8ECF4' },
  }
...
const features = [
  {
    img: img3,
    title: 'Habilidades que se adaptan a ti',
    text: 'Accede a un catálogo dinámico diseñado para potenciar tu crecimiento personal y profesional. En AulaDigitalPro, encontrarás recursos que se ajustan a tu ritmo de vida y a tus objetivos específicos. Ya sea que busques dominar una nueva tecnología o mejorar tus habilidades blandas, nuestros cursos interactivos te permiten aprender a tu manera, cuando y donde quieras, para impulsar tu carrera al siguiente nivel.',
  },
  {
    img: img4,
    title: 'Desarrolla ya las habilidades del futuro',
    text: 'El mercado laboral evoluciona rápidamente y nosotros te ponemos al frente. Descubre una formación estratégica pensada para las demandas del mañana, desde programación avanzada hasta liderazgo efectivo. Adquiere las competencias clave que garantizarán tu empleabilidad y éxito en los años venideros, preparándote no solo para adaptarte al cambio, sino para liderarlo.',
  },
  {
    img: img5,
    title: 'Comparte tus conocimientos',
    text: 'Tienes una experiencia valiosa que el mundo necesita conocer. Únete a nuestra comunidad de instructores y transforma tu expertise en oportunidades de aprendizaje para otros. En AulaDigitalPro, te facilitamos las herramientas para crear contenido educativo de calidad, conectar con estudiantes ávidos de saber y dejar una huella positiva en la educación global, impartiéndote como experto en tu campo.',
  },
]
...
export default function Home() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: gradients.app, fontFamily: FONT, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', bottom: '-180px', right: '-160px', width: '600px', height: '600px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(14,165,233,0.14) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      <section className="home-hero">
        <img className="home-hero__logo" src="/logo-gemini.jpg" alt="Logo AulaDigital Pro" />
      ...
      <section className="home-section">
        <div className="home-section__head">
          <h2>Aprende, evoluciona y comparte</h2>
          <p>Formación práctica que se adapta a tu vida y a las exigencias del futuro.</p>
        </div>
        <div className="home-features">
          {features.map((feature) => (
            <div key={feature.title} className="home-feature">
              <div className="home-feature__img">
